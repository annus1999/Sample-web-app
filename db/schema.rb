...
ActiveRecord::Schema.define(version: 2023_07_25_214217) do
  ...
  create_table "repository_users", force: :cascade do |t|
    ...
    t.index ["user_id", "repository_id"], name: "index_repository_users_on_user_id_and_repository_id", unique: true
